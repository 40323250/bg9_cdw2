...
task40323236 = Blueprint('task40323236', __name__, url_prefix='/bg7', template_folder='templates')

# scrum1_task1 為完整可以單獨執行的繪圖程式
@task40323236.route('/task36_1')
def task36_1():
    outstring = '''
...
# 上方轉 80 度
x2, y2 = mychain.basic_rot(x1, y1, 80, color="red")
# 上方轉 30 度
x3, y3 = mychain.basic_rot(x2, y2, 30, color="pink")
# 上方水平
x4, y4 = mychain.basic_rot(x3, y3, 0, color="yellow")
# 下半部, 從起點開始 -80 度
x5, y5 = mychain.basic_rot(0+65*2, -10+10+20*math.sin(80*deg)+20*math.sin(30*deg), -80, color="orange")
# 下斜 -30 度
...
'''
    ...
    response.headers['Access-Control-Allow-Origin'] = 'http://2016spring-40323236.rhcloud.com'
